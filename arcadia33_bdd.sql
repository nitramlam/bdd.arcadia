...
--
-- Host: mysql-arcadia33.alwaysdata.net
...
(7, 'Romain ', 'Expérience inoubliable ', 0, 0),
(8, 'test', 'test', 1, 1);
...
(5, 'employearcadia33@gmail.com', '$2y$10$cBvujf6Br18fEKlJZS7WTugRBOzF2epbLCo..kmlWb2YSEuQrKJ9C', 'employe'),
(7, 'josearcadia33@gmail.com', '$2y$10$dgLMWyJhM4ylJm14u3l7IOoclvvYJRvXXVkYwF2GzfNC3T2ATCN2e', 'administrateur'),
(8, 'veterinairearcadia@gmail.com', '$2y$10$.NREhrqDoe7s2potPD0rsOKslvqRu6ECf3Ni7/mH0ynecx3bunR5O', 'veterinaire');
...
--
ALTER TABLE `AVIS`
  MODIFY `avis_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `horaires`
  MODIFY `horaire_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
